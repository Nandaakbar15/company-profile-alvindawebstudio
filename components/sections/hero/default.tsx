...
const DEFAULT_HERO_MOCKUP = (
  <Screenshot
    ...
    alt="AlvindaWebStudio Screenshot"
    width={1248}
    height={765}
    loading="eager"
    className="w-full"
...
export default function Hero({
  title = "Building Modern Websites for Growing Businesses",
  description = "Membangun website profesional dengan teknologi modern untuk membantu bisnis Anda berkembang di era digital.",
